...
namespace listeners {
    class play_sound_when_object_is_placed_on_field : public engine::eventbus::subscriber<events::object_placed_on_field> {
    public:
        play_sound_when_object_is_placed_on_field(engine::audio::sound_manager &sound_manager, std::string sound_file);
