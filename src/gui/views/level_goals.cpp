...
namespace gui {
    namespace views {
        ...
        void level_goals::before() {
            // Load textures
            m_texture_manager.load_from_svg("images/ui-pack.svg", {{1261, 244}, {1451, 289}}, 1.5, "g_header");
            m_texture_manager.load_from_svg("images/ui-pack.svg", {{1261, 4}, {1451, 49}}, 1.5, "g_box");
            m_texture_manager.load_from_svg("images/ui-pack.svg", {{1261, 124}, {1451, 169}}, 1.5, "g_green_box");
