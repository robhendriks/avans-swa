...
namespace services{
    namespace wave{
        ...
        public:
            wave_management(std::shared_ptr<wavegenerator> wave_gen);
            ...
            void set_spawnable_nation(std::shared_ptr<domain::nations::nation> nation);
            ...
            void reset();
        private:
            std::shared_ptr<wavegenerator> m_wave_gen;
            ...
            std::shared_ptr<domain::nations::nation> m_spawnable_nation;

            // used to do last_time - time to see the difference between when last unit has spawned.
            std::vector<std::shared_ptr<std::pair<int, std::shared_ptr<domain::nations::enemy>>>> m_current_list;
