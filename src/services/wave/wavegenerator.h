...
namespace services {
    namespace wave{
        ...
        public:
            wavegenerator(domain::map::ai::ai &ai);
            ...
            std::vector<std::pair<int, domain::nations::enemy*>> generateEnemies(int _time, int _oppertunity, domain::nations::nation &_nation, bool _spread = false ,int capoppertunity = 0,bool _noboss = false);
            //RETURNS
            //Pair values
